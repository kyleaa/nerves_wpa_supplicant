defmodule WpaEncodeTest do
  ...
  test "commands" do
    ...
    assert Messages.encode({:SET_NETWORK, 1, :key_mgmt, :"WPA-PSK"}) == "SET_NETWORK 1 key_mgmt WPA-PSK"
    assert Messages.encode({:SET_NETWORK, 1, :key_mgmt, "WPA-PSK"}) == "SET_NETWORK 1 key_mgmt WPA-PSK"
    assert Messages.encode({:SET_NETWORK, 1, :key_mgmt, :NONE}) == "SET_NETWORK 1 key_mgmt NONE"
    assert Messages.encode({:SET_NETWORK, 1, :key_mgmt, "NONE"}) == "SET_NETWORK 1 key_mgmt NONE"
